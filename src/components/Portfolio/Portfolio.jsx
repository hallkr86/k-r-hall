...
import passwordgenerator from "../../images/passwordgeneratorpic.png";
...
const Portfolio = () => {
    ...
    return (
        ...
        <div className= "container">
            <section>
            <h1>My Projects</h1>
            <p> Currently in the process of searching for a free place to deploy my other full-stack applications. 
                <br></br>Take a look at my projects below that shows some of my skills, education, and experience.</p>
            <br></br>
            </section>
            <br></br>
            <br></br>
...
{/* <div className="card" style={{width: "18rem", background: "grey"}}> */}
            ...
            <div className="card-body">
            <h5 className="card-title">Password Generator</h5>
            <a href="https://hallkr86.github.io/passwordGenerator-kh/" target="_blank" rel="noreferrer" className="btn btn-dark">View Project</a>
            <a href="https://github.com/hallkr86/passwordGenerator-kh" target="_blank" rel="noreferrer" className="btn btn-dark">Github Repository</a>
            </div>
            </div>
